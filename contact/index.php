...
?>
  <main>
      ...
      <img src="assets/img/slider/contact%20us.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt="">
      ...
      <div class="contact-area pt-120 pb-90">
         <div class="container">
            <div class="row">
               <div class="col-xl-8 col-lg-7 col-md-12 try-shadow">
                  ...
                  <div class="row">
                     ...
                     <div class="colxl-2 ">
                        <div class="cont-btn mb-20">
                           <button type="submit" name="submit" class="cont-btn">Submit</button>
                        </div>
                     </div>
                     </form>
                  </div>
                        ...
                        <div class="support-contact-inner">
                           ...
                           <div class="support-item">
                              ...
                              <div class="support-info-email">
                                 <span>Email</span>
                                 <a href="mailto:info@millionairetrack.com"><span class="__cf_email__" data-cfemail="6821060e07280d10090518040d460b0705">info@millionairetrack.com</span></a>
                              </div>
                           </div>
                           <div class="support-item">
                             <!-- <div class="support-icon">
