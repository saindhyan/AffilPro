       ...
       ?>                                                                
            ...
            <a class="btn btn-warning w-100 shadow-none" style="background-color:#0284b4; border-color:#0284b4 ;" href = "course_player.php?id=<?php echo $row['cid']?>&part=1"> Start</a>                       </div>
              <?php  }else{
                                 ...
                                 ?>
            <div class="thumbnail__name text-center">
            <a class="btn btn-warning w-100 shadow-none"style="background-color:#0284b4; border-color:#0284b4 ;" href = "course_details.php?id=<?php echo $row['cid']?>"> Details</a><a class="btn btn-warning w-100 shadow-none" style="background-color:#0284b4; border-color:#0284b4 ; margin-left:20px;" href = "../payments/pay.php?course=<?php echo $row['cid']?>">Buy Now</a>                        </div>
               <?php }
               ?>
        </div>                                                       </div>
